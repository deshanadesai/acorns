...
def compile_code():
	if RUN_ISPC:
		...
		os.system(cmd)
		cmd = "gcc -O3 -o " + RUNNABLE_FILENAME + " objs/derivatives_ispc.o " + RUNNABLE_FILENAME + ".c" + DERIVATIVES_FILENAME + ".c " + " -lm"
		print(cmd)
		os.system(cmd)
	if RUN_C:
		if sys.platform.startswith('win'):
			...
			cmd = "gcc -O3 -o " + RUNNABLE_FILENAME + " " + RUNNABLE_FILENAME + ".c " + DERIVATIVES_FILENAME + ".c " + " -lm"
		print(cmd)
		os.system(cmd)
...
if __name__ == "__main__":
    ...
    plt.title('C Code vs Pytorch. # It: '+str(NUM_ITERATIONS) + " pytorch version: " + str(torch.__version__))
