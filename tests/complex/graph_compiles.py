...
runtimes, compile_times, functions, split_list, = convert_files_to_lists("./tests/complex/data/runs/data.json")

for function in functions:
    # generate_two_graph(runtimes[function], split_list, function, suffix="Runtimes")
    generate_two_graph(compile_times[function], split_list, function, suffix="Compile Times")
