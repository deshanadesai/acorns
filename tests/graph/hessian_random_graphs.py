...
def generate_full_graph(avg_us_grad, avg_wenzel_grad_static, avg_wenzel_grad_dynamic, avg_us_hess, avg_wenzel_hess_static, avg_wenzel_hess_dynamic, denom, function, label, num_vars):
    plt.plot(denom, avg_us_grad, color='#1abc9c',
             linestyle='dashed',  markersize=7)
    plt.plot(denom, avg_wenzel_grad_static, color='#f1c40f',
             linestyle='dashed', markersize=7)
    plt.plot(denom, avg_wenzel_grad_dynamic, color='#3498db',
             linestyle='dashed', markersize=7)
    plt.plot(denom, avg_us_hess, color='#34495e',
             linestyle='dashed', markersize=7)
    plt.plot(denom, avg_wenzel_hess_static, color='#bdc3c7',
             linestyle='dashed', markersize=7)
    plt.plot(denom, avg_wenzel_hess_dynamic, color='#e74c3c',
             linestyle='dashed', markersize=7)
    # legend
    plt.xlabel('Parameters', fontfamily='monospace')
    plt.ylabel('Time (s)', fontfamily='monospace')
...
def generate_max_graph(max_us_hess, max_wenzel_hess_static, max_wenzel_hess_dynamic, max_pytorch, denom):
    ...
    ax.plot(denom, max_wenzel_hess_static, color='#ff7979',
            linestyle='dashed', markersize=7)
    ax.plot(denom, max_wenzel_hess_dynamic, color='#badc58',
            linestyle='dashed', markersize=7)
...
generate_max_graph(us_max_hess, wenzel_hess_static_max,
                   wenzel_hess_dynamic_max, pytorch_max_hess, range(1, 11))
